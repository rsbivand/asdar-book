...
Pages 97 and 105: From sp 1.1-0, overlay is defunct and over methods must be used. The code in die_mod.R has been updated to correct the problem.
## cm2
...
Pages 116 and 118: From sp 1.1-0, overlay is defunct and over methods must be used. The code in cm2_mod.R has been updated to correct the problem.
## csdacm
Pages 137-140: From sp 1.1-0, overlay is defunct and over methods must be used. The code in csdacm_mod.R has been updated to correct the problem.
## sppa
...
Page 176: From sp 1.1-0, overlay is defunct and over methods must be used. The code in sppa_mod.R has been updated to correct the problem.
...
## geos
Pages 217 and 229: From sp 1.1-0, overlay is defunct and over methods must be used. The code in geos_mod.R has been updated to correct the problem.
