...
###################################################
### code chunk number 1: cm.Rnw:12-20
###################################################
...
###################################################
### code chunk number 3: cm.Rnw:28-29
###################################################
.iwidth <- 5
.iheight <- 6
.ipointsize <- 12
...
###################################################
## .epsNo <- .epsNo + 1; file <- paste("../Art/Fig-cm-", .epsNo, ".eps", sep="")
...
###################################################
## .epsNo <- .epsNo + 1; file <- paste("../Art/Fig-cm-", .epsNo, ".png", sep="")
...
###################################################
### code chunk number 18: cm.Rnw:384-386 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 22: cm.Rnw:488-489 (eval = FALSE)
###################################################
## getClass("Spatial")


###################################################
### code chunk number 23: cm.Rnw:491-495
###################################################
x <- getClass("Spatial")
xx <- capture.output(print(x))
cat(xx[1:7], sep="\n")
cat(strwrap(xx[8:length(xx)], width=getOption("width"), exdent=5), sep="\n")
...
###################################################
### code chunk number 26: cm.Rnw:551-553 (eval = FALSE)
###################################################
...
###################################################
bb <- matrix(c(350, 85, 370, 95), ncol=2, dimnames=list(NULL, c("min", "max")))
res <- try(Spatial(bb, proj4string=CRS("+proj=longlat")), silent=TRUE)
cat(res)


###################################################
### code chunk number 28: cm.Rnw:624-625
###################################################
setwd("../Data")
...
###################################################
### code chunk number 30: cm.Rnw:633-634
###################################################
setwd("../cm")


###################################################
### code chunk number 31: cm.Rnw:646-647 (eval = FALSE)
###################################################
## getClass("SpatialPoints")


###################################################
### code chunk number 32: cm.Rnw:649-653
###################################################
...
###################################################
### code chunk number 43: cm.Rnw:880-881 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 45: cm.Rnw:907-908 (eval = FALSE)
###################################################
## getClass("SpatialPointsDataFrame")


###################################################
### code chunk number 46: cm.Rnw:910-914
###################################################
...
###################################################
### code chunk number 51: cm.Rnw:999-1000
###################################################
setwd("../Data")
...
###################################################
### code chunk number 53: cm.Rnw:1006-1007
###################################################
setwd("../cm")
...
###################################################
### code chunk number 62: cm.Rnw:1214-1215
###################################################
setwd("../Data")
...
###################################################
### code chunk number 64: cm.Rnw:1222-1223
###################################################
setwd("../cm")
...
###################################################
### code chunk number 73: cm.Rnw:1488-1489
###################################################
setwd("../Data")
...
###################################################
### code chunk number 75: cm.Rnw:1501-1502
###################################################
setwd("../cm")


###################################################
### code chunk number 76: cm.Rnw:1512-1514 (eval = FALSE)
###################################################
...
###################################################
rownames(sat1)[2] <- "Arizona"
res <- try(SpatialPolygonsDataFrame(state.sp, sat1), silent=TRUE)
cat(res, sep="\n")
...
###################################################
### code chunk number 87: cm.Rnw:1754-1755 (eval = FALSE)
###################################################
## getClass("SpatialGrid")


###################################################
### code chunk number 88: cm.Rnw:1757-1761
###################################################
...
###################################################
### code chunk number 94: cm.Rnw:1877-1878 (eval = FALSE)
###################################################
## auck_el2 <- as(auck_el1, "SpatialPixelsDataFrame")
...
###################################################
### code chunk number 99: cm.Rnw:1980-1981
###################################################
setwd("../Data")
...
###################################################
### code chunk number 102: cm.Rnw:1989-1990
###################################################
setwd("../cm")
...
###################################################
### code chunk number 105: cm.Rnw:2037-2038 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 108: cm.Rnw:2088-2096
###################################################
...
###################################################
### code chunk number 109: cm.Rnw:2099-2100
###################################################
options(op)
