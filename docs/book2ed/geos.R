...
###################################################
### code chunk number 3: geos.Rnw:27-28
###################################################
.iwidth <- 5
.iheight <- 6
.ipointsize <- 12
...
###################################################
## .epsNo <- .epsNo + 1; file <- paste("../Art/Fig-geos-", .epsNo, ".eps", sep="")
...
## #cat("\\includegraphics[width=0.5\\textwidth]{", substr(file, 4, nchar(file)), "}\n\n", sep="")


###################################################
### code chunk number 6: afig_png (eval = FALSE)
###################################################
## .epsNo <- .epsNo + 1; file <- paste("../Art/Fig-geos-", .epsNo, ".png", sep="")
...
###################################################
### code chunk number 10: geos.Rnw:161-167 (eval = FALSE)
###################################################
## library(lattice)
## library(sp)
## data(meuse)
...
###################################################
### code chunk number 12: geos.Rnw:196-201 (eval = FALSE)
###################################################
...
postscript(file=file, onefile = TRUE, paper="special", width = .iwidth, height = .iheight, pointsize = .ipointsize, horizontal=FALSE)
lattice.options(default.theme = col.whitebg())
#print(xyplot(log(zinc)~sqrt(dist), as.data.frame(meuse), asp = 1, col = 'darkblue'), split = 
...
###################################################
### code chunk number 19: geos.Rnw:384-385 (eval = FALSE)
###################################################
## lm(log(zinc)~I(x^2)+I(y^2)+I(x*y) + x + y, meuse)


###################################################
### code chunk number 20: geos.Rnw:393-394 (eval = FALSE)
###################################################
## lm(log(zinc) ~ poly(x, y, degree = 2), meuse)


###################################################
### code chunk number 21: geos.Rnw:499-500 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 23: geos.Rnw:541-542 (eval = FALSE)
###################################################
## hscat(log(zinc)~1,meuse,(0:9)*100)
...
###################################################
### code chunk number 29: geos.Rnw:770-771 (eval = FALSE)
###################################################
## plot(variogram(log(zinc) ~ 1, meuse))


###################################################
### code chunk number 30: geos.Rnw:789-790 (eval = FALSE)
###################################################
## plot(variogram(log(zinc) ~ 1, meuse, alpha = c(0, 45, 90, 135)))


###################################################
### code chunk number 31: geos.Rnw:850-851 (eval = FALSE)
###################################################
## plot(variogram(log(zinc) ~ 1, meuse, cutoff = 1000, width = 50))


###################################################
### code chunk number 32: geos.Rnw:866-867 (eval = FALSE)
###################################################
## variogram(log(zinc) ~ 1, meuse, boundaries = c(0,50,100,seq(250,1500,250)))


###################################################
### code chunk number 33: geos.Rnw:903-905 (eval = FALSE)
###################################################
## show.vgms()
...
###################################################
### code chunk number 36: geos.Rnw:984-986 (eval = FALSE)
###################################################
## v <- variogram(log(zinc) ~ 1, meuse)
## plot(v)
...
###################################################
### code chunk number 47: geos.Rnw:1266-1267 (eval = FALSE)
###################################################
## plot(v.dir, v.anis)


###################################################
### code chunk number 48: geos.Rnw:1285-1286 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 50: geos.Rnw:1352-1353 (eval = FALSE)
###################################################
## plot(vm, vm.fit)
...
###################################################
### code chunk number 53: geos.Rnw:1432-1433 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 57: geos.Rnw:1634-1635 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 59: geos.Rnw:1665-1668 (eval = FALSE)
###################################################
## vm2.fit <- vm.fit
...
###################################################
### code chunk number 64: geos.Rnw:1776-1777 (eval = FALSE)
###################################################
## demo(pcb)
...
###################################################
### code chunk number 67: geos.Rnw:1921-1922 (eval = FALSE)
###################################################
## lz.pols <- krige(log(zinc)~1, meuse, meuse.polygons, v.fit)


###################################################
### code chunk number 68: geos.Rnw:1936-1937 (eval = FALSE)
###################################################
## spsample(polygon, n = 500, type = "regular", offset = c(.5, .5))


###################################################
### code chunk number 69: geos.Rnw:1985-1986
###################################################
options("width"=55)
...
###################################################
### code chunk number 71: geos.Rnw:1991-1992
###################################################
options("width"=70)
...
###################################################
### code chunk number 100: geos.Rnw:2631-2632 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 105: geos.Rnw:2823-2824 (eval = FALSE)
###################################################
## spplot(lzn.sim)
...
###################################################
### code chunk number 113: geos.Rnw:2988-2989 (eval = FALSE)
###################################################
## spplot(s1.sim)
...
###################################################
### code chunk number 120: geos.Rnw:3237-3238 (eval = FALSE)
###################################################
## PrintModelList()


###################################################
### code chunk number 121: geos.Rnw:3270-3272 (eval = FALSE)
###################################################
## library(geoR)
...
###################################################
### code chunk number 123: geos.Rnw:3337-3344
###################################################
sI <- capture.output(print(sessionInfo()))
cat(paste("%", sI[1:(length(sI))], sep=" "), sep="\n")
cat("\n")
...
###################################################
### code chunk number 124: geos.Rnw:3347-3348
###################################################
options(op)
